...
<div class="container-fluid">
    ...
    <div class="card col-lg-7 shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><a href="<?= base_url('admin/deptadmin') ?>"><i class="fas fa-arrow-left"></i> Back</a></h6>
        </div>
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="role_id">User Institute</label>
                    <select class="form-control" id="institute_id" name="institute_id">
                        <option value="">-Select-</option>
                        <option value="2">Department of Wildlife Conservation</option>
                        <option value="3">Department of Forest Conservation</option>
                    </select>
                </div>
                <!-- btn -->
