...
<div class="container-fluid">
    ...
    <div class="card col-lg-7 shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><a href="<?= base_url('admin/usermember') ?>"><i class="fas fa-arrow-left"></i> Back</a></h6>
        </div>
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $member['id']; ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            $datetime = (new \CodeIgniter\I18n\Time($member['date_created']));
                        ?>
                		<input class="form-control" type="text" name="date_created" value="<?= $datetime->format('d F Y');; ?>" readonly/>
                	</div>
                    <div class="form-group">
