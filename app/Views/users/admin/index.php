<?php
var_dump(session()->get("userdata")['role_id']);

$userdata = session()->get("userdata");
var_dump($userdata['role_id']);
?>
<!-- Begin Page Content -->
            ...
            <div class="card border-left-dark shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Department Admins</div>
                ...
                <small><a class="ml-3" href="<?= base_url('admin/deptadmin'); ?>">View &rarr;</a></small>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                ...
                <small><a class="ml-3" href="<?= base_url('admin/userdata'); ?>">View &rarr;</a></small>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
