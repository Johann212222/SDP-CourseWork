        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-emp-image"></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('/emplogin'); ?>">
                                ...
                                <!-- <div class="text-center">
                                    <a class="small" href="<?= site_url('login/registration'); ?>">Register!</a>
                                </div> -->
                            </div>
                        </div>
                    </div>
